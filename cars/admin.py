...
class CarInterestAdmin(admin.ModelAdmin):
    list_display = ('nome', 'email', 'telefone', 'carro')  # Campos a serem exibidos na lista
    search_fields = ('nome', 'email', 'carro__model')  # Permite buscar interesses pelo nome, email e modelo do carro
